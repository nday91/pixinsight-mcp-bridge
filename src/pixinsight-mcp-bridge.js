...
// Main PJSR Entry Point (V8 / ECMAScript 2025)
//
...
function loadCustomProcesses() {
   try {
      var json = Settings.read(SETTINGS_KEY_CUSTOM_PROCESSES, DataType.String);
      if (json) {
...
function saveCustomProcesses(processes) {
   try {
      Settings.write(SETTINGS_KEY_CUSTOM_PROCESSES, DataType.String, JSON.stringify(processes));
   } catch (e) {
 ...
 */
class IPCProcessor {
   constructor(externalProcess, dispatcher) {
   ...
   _handleCommand(msg) {
      ...
      try {
         this._process.standardInput = responseLine;
      } catch (e) {
...
class MCPBridgeDialog extends Dialog {
   constructor() {
      super();
      ...
      this.portLabel.textAlignment = TextAlignment.Right | TextAlignment.VertCenter;
      ...
      this.processIdLabel.textAlignment = TextAlignment.Right | TextAlignment.VertCenter;
      ...
      this.categoryLabel.textAlignment = TextAlignment.Right | TextAlignment.VertCenter;
      ...
      this.descriptionLabel.textAlignment = TextAlignment.Right | TextAlignment.VertCenter;
